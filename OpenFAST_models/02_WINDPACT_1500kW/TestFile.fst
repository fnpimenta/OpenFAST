----------------------     OpenFAST INPUT FILE      ------------------------------
Task #06: WindPACT 1.5 MW - Normal operation (6 m/s 10% TI wind; Reference torque curve)
----------------------      SIMULATION CONTROL      ------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
  "01_ElastoDyn/WP_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
  "unused"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
  "unused"      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
  "unused"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
  "02_InflowWind/InflowWind_W0400_Steady.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
  "03_AeroDyn/WP_AeroDyn.dat"      AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
  "04_ServoDyn/WP_ServoDyn.dat"      ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
