...
NREL 5MW Offshore Model: 6 m/s wind; Still water 
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"01_ElastoDyn\NREL5MW_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"02_InflowWind\InflowWind_W0600_T1000.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"03_AeroDyn\NREL5MW_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"04_ServoDyn\NREL5MW_ServoDyn.dat"     ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"05_HydroDyn\NREL_SemiSub_HydroDyn.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"06_SubDyn\"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"07_Mooring\NREL_SemiSub_MoorDyn.dat"      MooringFile     - Name of file containing mooring system input parameters (quoted string)
"08_Ice\"      IceFile         - Name of file containing ice input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
...
true          VTK_fields      - Write mesh fields to VTK data files? (flag) {true/false} [unused if WrVTK=0]
         8   VTK_fps         - Frame rate for VTK output (frames per second){will use closest integer multiple of DT} [used only if WrVTK=2]
